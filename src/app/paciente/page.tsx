          ...
          <section className="relative z-10 mx-auto mt-0 max-w-5xl px-4 pb-8 pt-5 sm:px-6 lg:px-10">
            ...
            {section === "alertas" && (
              <article className="rounded-[28px] border border-[#eee5e0] bg-white p-5 shadow-sm sm:p-7">
                ...
                <label className="mt-7 block min-w-0 text-sm font-bold text-[#433438]">Horário do lembrete<input type="time" value={reminderDraft.time} onChange={(event) => setReminderDraft((current) => ({ ...current, time: event.target.value }))} className="mt-2 box-border h-12 w-full min-w-0 max-w-full rounded-xl border border-[#e9dfda] bg-white px-4 font-normal outline-none focus:border-[#b91142] sm:max-w-48" /></label>
