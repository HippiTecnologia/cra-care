...
export default function NursingPage() {
  ...
  function printPrickReport(report: SavedReport) {
    if (!selected || report.report_type !== "prick_test") return;
