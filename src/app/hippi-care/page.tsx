    ...
    <main className="min-h-screen bg-[#070b1c] text-[#eef2ff]">
      <div className="mx-auto grid min-h-screen max-w-[1600px] lg:grid-cols-[272px_1fr]">
        <aside className="border-r border-violet-300/15 bg-[radial-gradient(circle_at_30%_0%,#382169_0%,#111533_42%,#080b1c_100%)] p-5 text-white sm:p-7 lg:sticky lg:top-0 lg:h-screen">
          <div className="flex items-center gap-3 border-b border-white/15 pb-6"><Image src="/hippi-mark.png" alt="Símbolo Hippi" width={256} height={256} priority className="h-14 w-14 rounded-2xl ring-1 ring-cyan-200/30 shadow-[0_0_24px_rgba(34,211,238,.28)]" /><div><p className="text-xl font-bold tracking-wide">Hippi Care</p><p className="mt-1 text-xs text-cyan-100/65">Painel da plataforma</p></div></div>
